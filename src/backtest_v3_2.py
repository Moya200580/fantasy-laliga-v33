...
# Fantasy LaLiga
#
# V3.2 - MEMORIA ADAPTATIVA BASADA EN FALLOS
#
...
MIN_APARICIONES_PENALIZACION = 4
...
print()
print("=" * 78)
print("🧪 BACKTEST DEL MODELO DE OPORTUNIDADES - V3.2")
print("=" * 78)
print()
...
def calcular_penalizacion_v3(
    ...
    """
    V3.2 - Penalizacion adaptativa basada exclusivamente en
...
print("=" * 78)
print("✅ BACKTEST ADAPTATIVO V3.2 COMPLETADO")
print("=" * 78)
print()
print("IMPORTANTE:")
print("La V3.2 NO penaliza por número de apariciones.")
